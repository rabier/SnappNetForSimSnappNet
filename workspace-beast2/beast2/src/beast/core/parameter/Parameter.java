...
public interface Parameter<T> extends Function {
    ...
    public abstract class Base<T> extends StateNode implements Parameter<T> {
        ...
        public void getStored() {
        	...
        	Log.debug.println("Je suis ds getStored() \n");  
        	Log.debug.println("Voici la storedValues" + storedValues.toString() + "\n");
        	Log.debug.println("Voici la longueur de storedValues" + storedValues.length + "\n");
        	Log.debug.println("Voici la Value" + values + "\n");
        	Log.debug.println("Voici la longueur de Value" + values.length + "\n");
        }
        ...
        protected void store() {
        	...
        	Log.debug.println("Je suis ds store de Parameter\n");  
            ...
            Log.debug.println("Voici les valeurs de storedValues que j ai stockees" + storedValues + "\n");
            Log.debug.println("La taille de  storedValues est" + storedValues.length + "\n");
        }

        @Override
        public void restore() {
        	
        	Log.debug.println("Je suis ds restore de Parameter\n");  
            Log.debug.println("Voici les storedValues" + storedValues + "\n");
            Log.debug.println("La taille de  storedValues est" + storedValues.length + "\n");
            Log.debug.println("Voici les nouvelles values" + values + "\n");        	            
            Log.debug.println("La taille de values est" + values.length + "\n");
