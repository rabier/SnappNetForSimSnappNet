...
import snappNetForSimSnappNet.core.COMPLEX;
import snappNetForSimSnappNet.matrix.AbstractMatrix;
import snappNetForSimSnappNet.matrix.Array2d;
import snappNetForSimSnappNet.matrix.QMatrix;
...
//		int q = 16;
		...
		for(int k=1;k<=EXPM_Q;k++) {
			...
			snappNetForSimSnappNet.matrix.Dgemm.dgemm('N', 'N', n, n, n, factor,	_A, 0, n, _B, 0, n, 0.0, _X, 0, n);
...
//		double * _tmp = new double[n2];
		...
		for(int k=1;k<=nrSquarings;k++) {
			...
			snappNetForSimSnappNet.matrix.Dgemm.dgemm ('N', 'N', n, n, n, 1.0,
					_A, 0, n, _A, 0, n, 0.0, _X, 0, n);
