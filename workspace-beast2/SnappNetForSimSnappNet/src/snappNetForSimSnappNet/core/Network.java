...
public class Network extends StateNode {
    ...
    //CE
    public String toString(DecimalFormat df, RealParameter coalescenceRate) {
        return getOrigin().toString(df, false, coalescenceRate);
    }
    //END CE
    ...
    public void restore() {
    	...
    	Log.debug.println("Je restaure Network a l aide de restore !!!\n");   
