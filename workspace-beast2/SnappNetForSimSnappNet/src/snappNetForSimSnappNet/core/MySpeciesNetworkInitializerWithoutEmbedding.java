 ...
 * @author Huw Ogilvie
 * @author Chi Zhang
 * modified by CE Rabier, not to deal with gene tree
 */

@Description("Set a starting point for a species-network analysis.")
public class MySpeciesNetworkInitializerWithoutEmbedding extends Tree implements StateNodeInitialiser {
	...
	*/
	/*
       ...
       // stree.initByName("initial", speciesTree, "taxonset", species,"clusterType", "upgma", "distance", distance);
        stree.initByName("initial", speciesTree, "taxonset", species,"clusterType", "upgma", "distance", 0.02);
