// this the class  GammaMover.java from SnAP, slightly modified by CE Rabier
...
public class ChangeGamma extends Operator {
	...
	public double proposal() {
		...
		int whichBranch = Randomizer.nextInt(coalescenceRate.getDimension());
